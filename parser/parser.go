...
func New(l *lexer.Lexer) *Parser {
	...
	// Read two tokens, to set both current and peek
	p.nextToken()
	p.nextToken()
	...
	p.registerPrefix(token.FUNCTION, p.parseFunctionLiteal)
...
func (p *Parser) parseFunctionLiteal() ast.Expression {
...
// Lookup the precedence associated with p.peekToken
...
// Lookup the precedence associated with p.curToken
